...
export default function Orders() {
  ...
  const loadOrders = (page = 1, resetPagination = false) => {
    console.log('Loading orders with filters:', filters, 'page:', page);
  ...
  return (
    <div className="p-6 space-y-6">
            ...
            <div className="flex items-center space-x-2 flex-1">
              ...
              <Select 
                ...
                onValueChange={(value) => {
                  ...
                  setTimeout(() => loadOrders(1, true), 100);
                }}
                disabled={isLoading}
              >
      ...
      {/* Keep existing modals and sheets - Order Details Drawer, Assign Modal, etc. */}
