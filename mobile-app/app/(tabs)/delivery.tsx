...
//     try {
//       // For now, we'll use dummy data since the API endpoints don't exist yet
      
//       // Simulate API delay
//       await new Promise(resolve => setTimeout(resolve, 1000));
      
//       // Dummy data for testing the UI
//       const dummyAvailableOrders: Order[] = [
//         {
...
//       const dummyAssignedOrders: Order[] = [
//         {
//           _id: '67890abcdef123456791',
...
//       setAvailableOrders(dummyAvailableOrders);
//       setAssignedOrders(dummyAssignedOrders);
//       setDeliveredOrders([]); // Empty for now
...
//     if (user?.role === 'delivery_partner' || user?.role === 'user') { // Allow 'user' for testing
//       fetchOrders();
//     }
//   }, [user, fetchOrders]);
...
//               // For now, just move the order from available to assigned
//               const orderToMove = availableOrders.find(order => order._id === orderId);
//               if (orderToMove) {
//                 setAvailableOrders(prev => prev.filter(order => order._id !== orderId));
//                 setAssignedOrders(prev => [...prev, { ...orderToMove, order_status: 'assigned' }]);
//               }
...
//               // For now, just move the order from assigned to delivered
//               const orderToMove = assignedOrders.find(order => order._id === orderId);
//               if (orderToMove) {
//                 setAssignedOrders(prev => prev.filter(order => order._id !== orderId));
//                 setDeliveredOrders(prev => [...prev, { ...orderToMove, order_status: 'delivered' }]);
//               }
